const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/storage-gICdOF_R.js","chunks/_commonjsHelpers-Cpj98o6Y.js","chunks/preload-helper-D7HrI6pR.js"])))=>i.map(i=>d[i]);
import{_ as v}from"../chunks/preload-helper-D7HrI6pR.js";let d=null;async function C(){return d||(d=(await v(()=>import("../chunks/storage-gICdOF_R.js").then(n=>n.o),__vite__mapDeps([0,1,2]))).default),d}chrome.runtime.onMessage.addListener((t,n,e)=>(S(t,e),!0));async function S(t,n){try{switch(await C(),t.type){case"SAVE_NOTE":const e=await d.saveNote(t.payload.note);n({success:!0,noteId:e});break;case"EXTRACT_CONTENT":const o=A();n(o);break;default:n({error:"Unknown content script message"})}}catch(e){console.error("Content script error:",e),n({error:e instanceof Error?e.message:"Content script error"})}}function A(){try{const t={url:window.location.href,title:document.title,content:"",metadata:{domain:window.location.hostname,language:document.documentElement.lang||"fr"}},n={description:a("description")||a("og:description"),author:a("author")||a("article:author"),publishDate:a("article:published_time")||a("date"),keywords:a("keywords"),ogImage:a("og:image"),siteName:a("og:site_name"),articleSection:a("article:section"),articleTag:a("article:tag")};Object.assign(t.metadata,n);const e=[()=>k(),()=>M(),()=>_([".content",".post-content",".entry-content",".article-content","#content",".main-content"]),()=>N()];for(const r of e){const l=r();if(l&&l.trim().length>100){t.content=l;break}}const o=L();return{success:!0,...t,type:o,extractedAt:Date.now()}}catch(t){return{success:!1,error:t instanceof Error?t.message:"Erreur extraction"}}}function a(t){const n=[`meta[name="${t}"]`,`meta[property="${t}"]`,`meta[name="twitter:${t}"]`,`meta[property="twitter:${t}"]`];for(const e of n){const o=document.querySelector(e);if(o){const r=o.getAttribute("content");if(r)return r}}return""}function k(){var e;const t=document.querySelector("article");return t&&((e=u(t.cloneNode(!0)).textContent)==null?void 0:e.trim())||""}function M(){var e;const t=document.querySelector('main, [role="main"]');return t&&((e=u(t.cloneNode(!0)).textContent)==null?void 0:e.trim())||""}function _(t){var n;for(const e of t){const o=document.querySelector(e);if(o){const l=((n=u(o.cloneNode(!0)).textContent)==null?void 0:n.trim())||"";if(l.length>100)return l}}return""}function N(){var e;const t=document.body.cloneNode(!0);return((e=u(t).textContent)==null?void 0:e.trim())||""}function u(t){return["script","style","nav","header","footer","aside",".navigation",".nav",".menu",".sidebar",".widget",".advertisement",".ads",".ad",".social",".share",".comments",".comment",".related",".recommended",'[class*="ad-"]','[id*="ad-"]','[class*="advertisement"]',".cookie-banner",".popup",".modal",".overlay"].forEach(e=>{t.querySelectorAll(e).forEach(o=>o.remove())}),t.querySelectorAll("*").forEach(e=>{const o=["href","src","alt","title"];Array.from(e.attributes).forEach(r=>{o.includes(r.name)||e.removeAttribute(r.name)})}),t}function L(){const t=window.location.href.toLowerCase(),n=document.title.toLowerCase(),e=window.location.hostname.toLowerCase();return t.includes(".pdf")?"pdf":e.includes("youtube")||e.includes("youtu.be")||e.includes("vimeo")||t.includes("/video/")?"video":e.includes("docs.")||t.includes("/docs/")||t.includes("/documentation/")||n.includes("documentation")?"documentation":e.includes("scholar.google")||e.includes("arxiv.org")||e.includes("researchgate")||e.includes("pubmed")||n.includes("research")||n.includes("study")||n.includes("journal")||a("article:section")?"research-paper":t.includes("/article/")||t.includes("/post/")||t.includes("/blog/")||a("article:published_time")?"article":"webpage"}function T(){if(document.getElementById("academic-notes-styles"))return;const t=document.createElement("style");t.id="academic-notes-styles",t.textContent=`
