...
import { ArrowLeft, LogIn, LogOut, Loader2, RefreshCw, ExternalLink } from 'lucide-react'
import type { Settings as SettingsType } from '@/types/academic'
import { getUser, signInWithGoogle, signOut } from '@/lib/auth'
      ...
      {currentUser ? (
        ...
        <>
          ...
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center space-y-4">
            ...
            <div>
              <p className="text-sm font-medium text-foreground mb-1">AOKnowledge</p>
              <p className="text-xs text-muted-foreground">
                Connecte-toi pour synchroniser tes notes<br />vers Journal d'Études
              </p>
            </div>
